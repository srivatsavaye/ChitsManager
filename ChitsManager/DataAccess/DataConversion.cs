...
namespace ChitsManager.DataAccess
{
    public static class DataConversion
    {
        ...
        public static void UpdateAuctionData(List<Auction> listAuctions)
        {
            ...
            {
                _dataController.UpdateAuctionByAuctionId(auction.AuctionId, auction.Month, auction.AuctionAmount, auction.PremiumAmount, auction.BonusAmount, auction.DueDate);
            }
        }
